...
const nuxtVersion = config.versions.nuxt
</script>
      ...
      <div class="max-w-7xl mx-auto p-6 lg:p-8">
        <div class="flex justify-center">
          <svg
            ...
            class="h-16 w-auto bg-gray-100 dark:bg-gray-900 fill-current text-gray-500"
          >
            <path
        ...
        <div class="flex justify-center mt-16 px-6 sm:items-center sm:justify-between">
          ...
          <div
            class="ml-4 text-center text-sm text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0 flex gap-2"
          >
